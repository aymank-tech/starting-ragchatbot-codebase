...
def _make_message(content_blocks, stop_reason="end_turn", role="assistant", model="claude-sonnet-4-20250514"):
    ...
    return t.Message(
        ...
        stop_sequence=None,
        usage=t.Usage(input_tokens=10, output_tokens=20, cache_creation_input_tokens=0, cache_read_input_tokens=0),
    )
...
def make_tool_use_response(tool_name: str, tool_input: dict, tool_id: str = "toolu_test_1"):
